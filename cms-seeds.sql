...
-- INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Italy", "Yesmynameisitaly", 4, 3);
-- INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Isaac", "Treehouse", 4, 3);

-- INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Morpheus", "Fishburne", 5, null);
-- INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Neo", "Reeves", 6, 5);
-- INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Trinity", "Moss", 6, 5);

-- INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Pauline", "Boss", 7, null);
-- INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ("Seb", "Opto", 8, 7);
